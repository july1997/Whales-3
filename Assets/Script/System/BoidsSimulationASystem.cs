...
public class BoidsSimulationSystem : JobComponentSystem
{
    ...
    [BurstCompile]
    public struct WallJob : IJobForEach<Translation, Acceleration>
    {
    ...
    private struct MoveJob : IJobForEach<Translation, Rotation, Velocity, Acceleration>
    {
        ...
        public void Execute(ref Translation translation, [WriteOnly] ref Rotation rot, ref Velocity velocity, ref Acceleration accel)
        {
