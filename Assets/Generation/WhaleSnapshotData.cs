...
{
    public uint tick;
    private int PlayerCommandDataPlayerId;
    ...
    public int GetPlayerCommandDataPlayerId(GhostDeserializerState deserializerState)
    {
        return (int)PlayerCommandDataPlayerId;
    }
    public int GetPlayerCommandDataPlayerId()
    {
        return (int)PlayerCommandDataPlayerId;
    }
    public void SetPlayerCommandDataPlayerId(int val, GhostSerializerState serializerState)
    {
        PlayerCommandDataPlayerId = (int)val;
    }
    public void SetPlayerCommandDataPlayerId(int val)
    {
        PlayerCommandDataPlayerId = (int)val;
    }
    ...
    public void PredictDelta(uint tick, ref WhaleSnapshotData baseline1, ref WhaleSnapshotData baseline2)
    {
        ...
        PlayerCommandDataPlayerId = predictor.PredictInt(PlayerCommandDataPlayerId, baseline1.PlayerCommandDataPlayerId, baseline2.PlayerCommandDataPlayerId);
    ...
    {
        changeMask0 = (PlayerCommandDataPlayerId != baseline.PlayerCommandDataPlayerId) ? 1u : 0;
        ...
        NetworkCompressionModel compressionModel)
    {
        ...
        if ((changeMask0 & (1 << 0)) != 0)
            PlayerCommandDataPlayerId = reader.ReadPackedIntDelta(baseline.PlayerCommandDataPlayerId, compressionModel);
        else
            PlayerCommandDataPlayerId = baseline.PlayerCommandDataPlayerId;
        if ((changeMask0 & (1 << 1)) != 0)
        {
