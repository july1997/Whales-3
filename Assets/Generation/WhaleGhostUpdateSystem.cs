...
#pragma warning restore 649
        ...
        public ArchetypeChunkComponentType<PlayerCommandData> ghostPlayerCommandDataType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            var ghostPlayerCommandDataArray = chunk.GetNativeArray(ghostPlayerCommandDataType);
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                var ghostPlayerCommandData = ghostPlayerCommandDataArray[entityIndex];
    ...
    protected override void OnCreate()
    {
        ...
        m_interpolatedQuery = GetEntityQuery(new EntityQueryDesc
        {
            All = new []{
                ...
                ComponentType.ReadWrite<PlayerCommandData>(),
    ...
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostPlayerCommandDataType = GetArchetypeChunkComponentType<PlayerCommandData>(),
...
public partial class WhaleGhostSpawnSystem : DefaultGhostSpawnSystem<WhaleSnapshotData>
{
    struct SetPredictedDefault : IJobParallelFor
    {
        ...
        {
            if (localPlayerId.Length == 1 && snapshots[index].GetPlayerCommandDataPlayerId() == localPlayerId[0].Value)
